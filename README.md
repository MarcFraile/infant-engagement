...
* To calculate reliability scores comparing human-human agreement and human-machine agreement, use `scripts/attention_comparison/human_machine_reliability.py`. Results are saved as PNG and CV in `artifacts/human_machine_reliability`.
